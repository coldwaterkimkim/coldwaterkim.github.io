import"../modulepreload-polyfill-Dezn_h7o.js";import{W as e,Y as t,b as n,j as r,l as i,m as a,q as o,v as s}from"../pb-Ck1Egqnf.js";/* empty css               */o()||(window.location.replace(`/admin/login.html`),await new Promise(()=>{})),document.getElementById(`logoutBtn`).addEventListener(`click`,e=>{e.preventDefault(),t(),window.location.href=`/admin/login.html`});var c=1;window.confirmDelete=p,window.goToPage=f;function l(e,t){let n=document.getElementById(`alert`);n.textContent=e,n.className=`alert alert-${t}`,n.style.display=`block`,setTimeout(()=>n.style.display=`none`,5e3)}async function u(t=1){let a=document.querySelector(`#guestbookTable tbody`);a.innerHTML=`<tr><td colspan="4" class="loading">불러오는 중</td></tr>`;try{let i=await r(t,20);if(c=t,document.getElementById(`stats`).textContent=`전체 방명록 수: ${i.totalItems}개`,i.items.length===0){a.innerHTML=`<tr><td colspan="4">방명록이 비어있습니다.</td></tr>`;return}a.innerHTML=i.items.map(t=>`
          <tr>
            <td><b>${s(t.name)}</b></td>
            <td>${s(t.message)}</td>
            <td>${n(e(t))}</td>
