...
OWNER uploads accept multiple MP3 files in one selection. The schedule table can remove a track from the playlist and schedule; its PocketBase media record is deleted only when no other content references it.
