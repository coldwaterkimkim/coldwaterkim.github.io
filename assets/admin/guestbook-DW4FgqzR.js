import{_ as e,c as t,g as n,n as r,o as i,r as a,u as o,y as s}from"../pb-T5ptYq7e.js";/* empty css               */e()||(window.location.replace(`/admin/login.html`),await new Promise(()=>{})),document.getElementById(`logoutBtn`).addEventListener(`click`,e=>{e.preventDefault(),s(),window.location.href=`/admin/login.html`});var c=1;window.confirmDelete=p,window.goToPage=f;function l(e,t){let n=document.getElementById(`alert`);n.textContent=e,n.className=`alert alert-${t}`,n.style.display=`block`,setTimeout(()=>n.style.display=`none`,5e3)}async function u(e=1){let a=document.querySelector(`#guestbookTable tbody`);a.innerHTML=`<tr><td colspan="4" class="loading">불러오는 중</td></tr>`;try{let r=await o(e,20);if(c=e,document.getElementById(`stats`).textContent=`전체 방명록 수: ${r.totalItems}개`,r.items.length===0){a.innerHTML=`<tr><td colspan="4">방명록이 비어있습니다.</td></tr>`;return}a.innerHTML=r.items.map(e=>`
          <tr>
            <td><b>${i(e.name)}</b></td>
            <td>${i(e.message)}</td>
            <td>${t(n(e))}</td>
