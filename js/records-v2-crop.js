...
export function openPhotoEditor(attachment, {body = ''} = {}) {
  return new Promise(resolve => {
    ...
    dialog.querySelector('.rv2-crop-hint').textContent = '사진 아래에 표시돼. 비워두면 빈칸으로 남고, 게시물의 글은 사진 위에 계속 보여.';
