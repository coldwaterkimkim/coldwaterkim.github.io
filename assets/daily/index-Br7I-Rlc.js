import{F as e,S as t,W as n,Z as r,b as i,c as a,l as o,q as s,r as c,v as l}from"../pb-Diol6JGC.js";import"../site-BpBU53Zl.js";var u=null,d=[],f=10,p=n();window.goToDailyPage=y,p&&(document.getElementById(`owner-col-head`).style.display=``,document.getElementById(`daily-note`).textContent=`OWNER MODE: 초안까지 같이 보입니다.`,document.getElementById(`owner-tools`).innerHTML=`
        <div class="owner-bar">
          <b>OWNER MODE</b> ·
