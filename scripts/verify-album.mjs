...
check(ALBUM_PAGE_SIZE === 60, 'album page size must remain 60');
...
check(albumJs.includes("return 6") && albumJs.includes("return 8") && albumJs.includes("return 10"), 'home preview 6/8/10');
