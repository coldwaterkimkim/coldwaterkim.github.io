...
assert.match(dailyIndex, /return ownerMode \? `\/daily\/view\.html\?day=\$\{encodedDay\}` : `\/daily\/\$\{encodedDay\}\/`/);
assert.match(daily, /return ownerMode \? `\/daily\/view\.html\?day=\$\{encodedDay\}` : `\/daily\/\$\{encodedDay\}\/`/);
